...
class Scoreboard():
    """A class representing the on-screen scoreboard"""
    ...
    def __init__(self, ai_settings, screen, stats):
        ...
        #Prepare initial scoreboard image
        self.prep_score()
    ...
    def prep_high_score(self):
        ...
        self.high_score_image = self.font.render(high_score_str, True, self.text_colour, self.ai_settings.screen_colour)
    ...
    def prep_level(self):
        ...
        self.level_image = self.font.render(str(self.stats.level), True, self.text_colour, self.ai_settings.screen_colour)

        # Display the score at the top right of the screen
        self.level_rect = self.level_image.get_rect()
        self.level_rect.right = self.screen_rect.right - 20
        self.level_rect.top = self.score_rect.bottom + self.score_rect.height / 4
